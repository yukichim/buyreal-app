...
export class InMemoryProductRepository implements ProductRepository {
	...
	private initializeSampleData(): void {
		...
		for (const i of sampleProducts) {
			this.products.set(i.id.value, new ProductEntity(i));
		}
	}
	...
	async getByPage(): Promise<ProductEntity[]> {
		const reviews = Array.from(this.products.values());
		return reviews;
	}
